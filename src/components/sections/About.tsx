      ...
      <div className="flex flex-col items-center gap-5" data-aos="fade-up">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-600 leading-relaxed">
            ...
            <span>React, Next.js, TypeScript, and Tailwind CSS.</span> I’m
            passionate about building clean, responsive, and user-focused web
            experiences that merge creativity with functionality. Coming from
            humble beginnings, I’ve learned the value of resilience, focus, and
            growth through every challenge. Each project I take on reflects my
